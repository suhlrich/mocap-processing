...
plateNamesOG = {'1','2','3'} ; % Reset this to 1,2,3 for generality if desired
...
for i=1:b;
    ...
    if k>0
        ...
        forceplate_3_massForce = mean(GRF_write(:,20));
        Forceplate_totalmass_force = forceplate_2_massForce + forceplate_3_massForce;
