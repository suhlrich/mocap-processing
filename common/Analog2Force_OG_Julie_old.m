function [forces_proc_meters] = Analog2Force_OG_Julie(forcesV,threshold,lpFiltFreq,samp_rate) ;
...
OGCalibMatrix.FP3 = diag([1000 1000 2000 600 400 300]) ;
...
%     [B_f,A_f] = butter(4,lpFiltFreq/(samp_rate/2)) ; 
