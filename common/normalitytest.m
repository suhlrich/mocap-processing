function [normal_binary, p] = normalitytest(x)

%% Scott hacked this to do Shapiro Wilkes only
%% output 1: Binary if normal or not (1 if normal)
%% output 2: P value - if greater than 0.05, it's normal
